...
public:
 ...
 //---------------------------------------------------------------------------------Construtores
  ...
  Gnuplot &  PlotSlope  (const double a, const double b, const std::string & title = "")
    ...
    Gnuplot &  plot_logSlope (const double a, const double b, const std::string & title = "");

     /// @brief Plota uma equacao da forma y = ax + b, voce fornece os coeficientes a e b.
  Gnuplot &  PlotlogSlope  (const double a, const double b, const std::string & title = "")
						    { return plot_logSlope(a,b,title); }
